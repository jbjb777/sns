...
(function () {
  ...
  function ensureHost() {
    ...
    toastHost.innerHTML = `<style>
      ...
      .sharer-toast__icon{width:auto;height:auto;max-width:20px;max-height:20px;flex:0 0 20px;display:block;object-fit:contain;object-position:center;border-radius:50%;background:rgba(255,255,255,.13)}
