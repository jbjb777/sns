...
(function () {
  ...
  function ensureHost() {
    ...
    toastHost.innerHTML = `<style>
      ...
      .sharer-toast__icon{width:auto;height:auto;max-width:30px;max-height:30px;flex:0 0 30px;display:block;object-fit:contain;object-position:center;border-radius:50%;background:rgba(255,255,255,.13)}
